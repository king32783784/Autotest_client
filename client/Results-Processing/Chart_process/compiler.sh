...
compiler()
{
    ...
    TimedImageMagick=`check $TimedImageMagic`
    ...
    if [ $TYPE = "MORE" ]
    then
        echo "('$OSDIR', [[0,$Npb], [1,$Ripper], [2,$X264], [3,$Sharpen], [4,$Resizing], [5,$Hwbcolor], [6,$Zip], [7,$Openssl], [8,$Apache], [9,0]]),"   
    else
        echo "('$OSDIR', [[0,$Hmmer], [1,$Gcrypt], [2,$TimedApache], [3,$TimedImageMagick], [4,$TimedPHP], [5,$Cray], [6,$Raytests], [7,$Fall], [8,$Stack], [9,$Convex], [10,$Trimesh], [11,$Encodemp3], [12,0]]),"
    fi
}
compiler
